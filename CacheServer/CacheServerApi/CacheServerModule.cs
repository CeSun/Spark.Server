...
namespace CacheServerApi
{
    public class CacheServerModule: Singleton<CacheServerModule>
    {
        ...
        public Task<(Head, QueryRsp)> QueryAsync(string table, string key)
        {
            ...
            CoroutineUtil.Instance.New(async () => await proxyModule.SendToAsync(new Proxyapi.TargetSvr { Id = 1, Name = "CacheServer", Type = Proxyapi.ETransmitType.Poll, Zone = 0 }, Proxyapi.EPackType.Request, data));
            Frame.Timer.Instance.SetTimeOut(1000, () => {
